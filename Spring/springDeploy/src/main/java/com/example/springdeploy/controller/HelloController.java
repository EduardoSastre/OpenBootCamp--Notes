...
public class HelloController {
    ...
    @Value("${app.message}") //This is in application.properties
    String message;

    @Value("${app.varexample}") //This is in application.properties --- Also is a environment variable
    String varexample;

    @GetMapping("/hola")
    public String helloWorld(){
        return message + ", " + varexample;
    }
